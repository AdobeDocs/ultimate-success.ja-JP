---
title: GenStudio for Performance MarketingとMarketoを使用したメール施策
description: GenStudioとMarketoを統合して、メールキャンペーンを合理化し、コラボレーションを強化して、マーケティングパフォーマンスを最適化する方法をご確認ください。
...
# GenStudio for Performance MarketingとMarketoを使用したメール施策
